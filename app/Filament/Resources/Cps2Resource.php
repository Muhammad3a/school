...
use App\Filament\Resources\Cps2Resource\Pages;
use Illuminate\Database\Eloquent\SoftDeletingScope;
use App\Filament\Resources\Cps2Resource\RelationManagers;

class Cps2Resource extends Resource
{
    protected static ?string $model = Cps2::class;

    protected static ?string $navigationIcon = 'heroicon-o-rectangle-stack';

    protected static ?string $navigationLabel = 'Capaian Semester 2';
    ...
    {
        return [
            'index' => Pages\ListCps2s::route('/'),
            'create' => Pages\CreateCps2::route('/create'),
            'edit' => Pages\EditCps2::route('/{record}/edit'),
        ];
    }
}
