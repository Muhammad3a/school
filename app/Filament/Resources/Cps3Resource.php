...
use App\Filament\Resources\Cps3Resource\Pages;
use Illuminate\Database\Eloquent\SoftDeletingScope;
use App\Filament\Resources\Cps3Resource\RelationManagers;

class Cps3Resource extends Resource
{
    protected static ?string $model = Cps3::class;

    protected static ?string $navigationIcon = 'heroicon-o-rectangle-stack';

    protected static ?string $navigationLabel = 'Capaian Semester 3';
    ...
    {
        return [
            'index' => Pages\ListCps3s::route('/'),
            'create' => Pages\CreateCps3::route('/create'),
            'edit' => Pages\EditCps3::route('/{record}/edit'),
        ];
    }
}
