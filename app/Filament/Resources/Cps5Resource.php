...
use App\Filament\Resources\Cps5Resource\Pages;
use Illuminate\Database\Eloquent\SoftDeletingScope;
use App\Filament\Resources\Cps5Resource\RelationManagers;

class Cps5Resource extends Resource
{
    protected static ?string $model = Cps5::class;

    protected static ?string $navigationIcon = 'heroicon-o-rectangle-stack';

    protected static ?string $navigationLabel = 'Capaian Semester 5';
    ...
    {
        return [
            'index' => Pages\ListCps5s::route('/'),
            'create' => Pages\CreateCps5::route('/create'),
            'edit' => Pages\EditCps5::route('/{record}/edit'),
        ];
    }
}
