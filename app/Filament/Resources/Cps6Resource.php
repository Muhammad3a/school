...
use App\Filament\Resources\Cps6Resource\Pages;
use Illuminate\Database\Eloquent\SoftDeletingScope;
use App\Filament\Resources\Cps6Resource\RelationManagers;

class Cps6Resource extends Resource
{
    protected static ?string $model = Cps6::class;

    protected static ?string $navigationIcon = 'heroicon-o-rectangle-stack';

    protected static ?string $navigationLabel = 'Capaian Semester 6';
    ...
    {
        return [
            'index' => Pages\ListCps6s::route('/'),
            'create' => Pages\CreateCps6::route('/create'),
            'edit' => Pages\EditCps6::route('/{record}/edit'),
        ];
    }
}
