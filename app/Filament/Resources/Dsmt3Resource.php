...
use App\Filament\Resources\Dsmt3Resource\Pages;
use Illuminate\Database\Eloquent\SoftDeletingScope;
use App\Filament\Resources\Dsmt3Resource\RelationManagers;

class Dsmt3Resource extends Resource
{
    protected static ?string $model = Dsmt3::class;
    ...
    public static function getNavigationItems(): array
    {
        ...
        return [
            NavigationItem::make()
                ->label('Nilai Disiplin Semester 3')
