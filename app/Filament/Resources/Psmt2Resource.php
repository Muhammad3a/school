...
use App\Filament\Resources\Psmt2Resource\Pages;
use Illuminate\Database\Eloquent\SoftDeletingScope;
use App\Filament\Resources\Psmt2Resource\RelationManagers;

class Psmt2Resource extends Resource
{
    protected static ?string $model = Psmt2::class;

    protected static ?string $navigationIcon = 'heroicon-o-rectangle-stack';

    protected static ?string $navigationLabel = 'Nilai Pembiasaan Semester 2';
    ...
    public  static function getLabel(): ?string
    {
        ...
        if ($locale == 'id') {
            return "Nilai 10 Pembiasaan Semester 2";
        } else
            return "Teacher";
    }
}
