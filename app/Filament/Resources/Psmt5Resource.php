...
use App\Filament\Resources\Psmt5Resource\Pages;
use Illuminate\Database\Eloquent\SoftDeletingScope;
use App\Filament\Resources\Psmt5Resource\RelationManagers;

class Psmt5Resource extends Resource
{
    protected static ?string $model = Psmt5::class;

    protected static ?string $navigationIcon = 'heroicon-o-rectangle-stack';

    protected static ?string $navigationLabel = 'Nilai Pembiasaan Semester 5';
    ...
    {
        return [
            'index' => Pages\ListPsmt5s::route('/'),
            'create' => Pages\CreatePsmt5::route('/create'),
            'edit' => Pages\EditPsmt5::route('/{record}/edit'),
        ];
    }
    ...
    public  static function getLabel(): ?string
    {
        ...
        if ($locale == 'id') {
            return "Nilai 10 Pembiasaan Semester 5";
        } else
            return "Teacher";
    }
}
