    ...
    <div style="display: flex; justify-content: center; align-items: center;">
        <table style="border-collapse: collapse; margin-top: 5px; margin-bottom: 5px; width: 70%; text-align: left;">
            ...
            <tr>
                ...
                <td style="padding: 5px; width: 35%;">: Genap / 2</td>
            </tr>
            <tr>
    ...
    <table border="1" cellpadding="5" cellspacing="0" >
        ...
        <tbody>            
            ...
            <tr>
                ...
                <td class="border border-gray-300 px-4 py-2 text-center">{{ $student->esmt2->video ?? '-' }}</td>
                <td class="border border-gray-300 px-4 py-2 text-center">{{ isset($student->esmt2->video) ? $student->getPredikatP($student->esmt2->video) : '-' }}</td>
                <td rowspan="9" class="border border-gray-300 px-4 py-2">
                    Ananda menunjukkan {{ $student->getPredikatP($student->esmt2->video ?? 0) }} sesuai harapan pada kegiatan Eskul.
                </td>
            </tr>

            <tr>                        
                <td class="border border-gray-300 px-4 py-2">2. potografer</td>
                <td class="border border-gray-300 px-4 py-2 text-center">{{ $student->esmt2->foto ?? '-' }}</td>
                <td class="border border-gray-300 px-4 py-2 text-center">{{ isset($student->esmt2->foto) ? $student->getPredikatP($student->esmt2->foto) : '-' }}</td>                       
            </tr>

            <tr>                        
                <td class="border border-gray-300 px-4 py-2">3. Desain</td>
                <td class="border border-gray-300 px-4 py-2 text-center">{{ $student->esmt2->desain ?? '-' }}</td>
                <td class="border border-gray-300 px-4 py-2 text-center">{{ isset($student->esmt2->desain) ? $student->getPredikatP($student->esmt2->desain) : '-' }}</td>                       
            </tr>

            <tr>                        
                <td class="border border-gray-300 px-4 py-2">4. Kaligrafi</td>
                <td class="border border-gray-300 px-4 py-2 text-center">{{ $student->esmt2->kaligerafi ?? '-' }}</td>
                <td class="border border-gray-300 px-4 py-2 text-center">{{ isset($student->esmt2->kaligerafi) ? $student->getPredikatP($student->esmt2->kaligerafi) : '-' }}</td>                       
            </tr>

            <tr>                        
                <td class="border border-gray-300 px-4 py-2">5. English Club</td>
                <td class="border border-gray-300 px-4 py-2 text-center">{{ $student->esmt2->engclub ?? '-' }}</td>
                <td class="border border-gray-300 px-4 py-2 text-center">{{ isset($student->esmt2->engclub) ? $student->getPredikatP($student->esmt2->engclub) : '-' }}</td>                       
            </tr>

            <tr>                        
                <td class="border border-gray-300 px-4 py-2">6. Hadroh</td>
                <td class="border border-gray-300 px-4 py-2 text-center">{{ $student->esmt2->hadroh ?? '-' }}</td>
                <td class="border border-gray-300 px-4 py-2 text-center">{{ isset($student->esmt2->hadroh) ? $student->getPredikatP($student->esmt2->hadroh) : '-' }}</td>                       
            </tr>

            <tr>                        
                <td class="border border-gray-300 px-4 py-2">7. Vollyball</td>
                <td class="border border-gray-300 px-4 py-2 text-center">{{ $student->esmt2->voli ?? '-' }}</td>
                <td class="border border-gray-300 px-4 py-2 text-center">{{ isset($student->esmt2->voli) ? $student->getPredikatP($student->esmt2->voli) : '-' }}</td>                       
            </tr>

            <tr>                        
                <td class="border border-gray-300 px-4 py-2">8. Futsal</td>
                <td class="border border-gray-300 px-4 py-2 text-center">{{ $student->esmt2->futsal ?? '-' }}</td>
                <td class="border border-gray-300 px-4 py-2 text-center">{{ isset($student->esmt2->futsal) ? $student->getPredikatP($student->esmt2->futsal) : '-' }}</td>                       
            </tr>

            <tr>                        
                <td class="border border-gray-300 px-4 py-2">9. Silat</td>
                <td class="border border-gray-300 px-4 py-2 text-center">{{ $student->esmt2->silat ?? '-' }}</td>
                <td class="border border-gray-300 px-4 py-2 text-center">{{ isset($student->esmt2->silat) ? $student->getPredikatP($student->esmt2->silat) : '-' }}</td>                       
            </tr>
