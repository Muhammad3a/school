    ...
    <div style="display: flex; justify-content: center; align-items: center;">
        <table style="border-collapse: collapse; margin-top: 5px; margin-bottom: 5px; width: 70%; text-align: left;">
            ...
            <tr>
                ...
                <td style="padding: 5px; width: 35%;">: Genap / 6</td>
            </tr>
            <tr>
                <td style="padding: 5px; width: 0%;"><strong>Kelas</strong></td>
                <td style="padding: 5px; width: 0%;">: {{ $student->smt6->kelas->name_kelas ?? '-' }} (Dua Belas)</td>
                <td style="padding: 5px; width: 10%;"><strong>Tahun Pelajaran</strong></td>
                <td style="padding: 5px; width: 20%;">: {{ $student->smt6->priode->name ?? '-' }}</td>
            </tr>
        </table>
    </div> 
            ...
            <tr>
                ...
                <td class="border border-gray-300 px-4 py-2 text-center">{{ isset($student->esmt6->kebekerjaan) ? $student->getPredikatP($student->esmt6->kebekerjaan) : '-' }}</td>
                     ...
                     <tr>
                        ...
                        <td class="border border-gray-300 px-4 py-2 text-center">{{ $student->esmt6->video ?? '-' }}</td>
                        <td class="border border-gray-300 px-4 py-2 text-center">{{ isset($student->esmt6->video) ? $student->getPredikatP($student->esmt6->video) : '-' }}</td>
                        <td rowspan="9" class="border border-gray-300 px-4 py-2">
                            Ananda menunjukkan {{ $student->getPredikatP($student->esmt6->video ?? 0) }} sesuai harapan pada kegiatan Eskul.
                        </td>
                    </tr>

                    <tr>                        
                        <td class="border border-gray-300 px-4 py-2">2. potografer</td>
                        <td class="border border-gray-300 px-4 py-2 text-center">{{ $student->esmt6->foto ?? '-' }}</td>
                        <td class="border border-gray-300 px-4 py-2 text-center">{{ isset($student->esmt6->foto) ? $student->getPredikatP($student->esmt6->foto) : '-' }}</td>                       
                    </tr>

                    <tr>                        
                        <td class="border border-gray-300 px-4 py-2">3. Desain</td>
                        <td class="border border-gray-300 px-4 py-2 text-center">{{ $student->esmt6->desain ?? '-' }}</td>
                        <td class="border border-gray-300 px-4 py-2 text-center">{{ isset($student->esmt6->desain) ? $student->getPredikatP($student->esmt6->desain) : '-' }}</td>                       
                    </tr>

                    <tr>                        
                        <td class="border border-gray-300 px-4 py-2">4. Kaligrafi</td>
                        <td class="border border-gray-300 px-4 py-2 text-center">{{ $student->esmt6->kaligerafi ?? '-' }}</td>
                        <td class="border border-gray-300 px-4 py-2 text-center">{{ isset($student->esmt6->kaligerafi) ? $student->getPredikatP($student->esmt6->kaligerafi) : '-' }}</td>                       
                    </tr>

                    <tr>                        
                        <td class="border border-gray-300 px-4 py-2">5. English Club</td>
                        <td class="border border-gray-300 px-4 py-2 text-center">{{ $student->esmt6->engclub ?? '-' }}</td>
                        <td class="border border-gray-300 px-4 py-2 text-center">{{ isset($student->esmt6->engclub) ? $student->getPredikatP($student->esmt6->engclub) : '-' }}</td>                       
                    </tr>

                    <tr>                        
                        <td class="border border-gray-300 px-4 py-2">6. Hadroh</td>
                        <td class="border border-gray-300 px-4 py-2 text-center">{{ $student->esmt6->hadroh ?? '-' }}</td>
                        <td class="border border-gray-300 px-4 py-2 text-center">{{ isset($student->esmt6->hadroh) ? $student->getPredikatP($student->esmt6->hadroh) : '-' }}</td>                       
                    </tr>

                    <tr>                        
                        <td class="border border-gray-300 px-4 py-2">7. Vollyball</td>
                        <td class="border border-gray-300 px-4 py-2 text-center">{{ $student->esmt6->voli ?? '-' }}</td>
                        <td class="border border-gray-300 px-4 py-2 text-center">{{ isset($student->esmt6->voli) ? $student->getPredikatP($student->esmt6->voli) : '-' }}</td>                       
                    </tr>

                    <tr>                        
                        <td class="border border-gray-300 px-4 py-2">8. Futsal</td>
                        <td class="border border-gray-300 px-4 py-2 text-center">{{ $student->esmt6->futsal ?? '-' }}</td>
                        <td class="border border-gray-300 px-4 py-2 text-center">{{ isset($student->esmt6->futsal) ? $student->getPredikatP($student->esmt6->futsal) : '-' }}</td>                       
                    </tr>

                    <tr>                        
                        <td class="border border-gray-300 px-4 py-2">9. Silat</td>
                        <td class="border border-gray-300 px-4 py-2 text-center">{{ $student->esmt6->silat ?? '-' }}</td>
                        <td class="border border-gray-300 px-4 py-2 text-center">{{ isset($student->esmt6->silat) ? $student->getPredikatP($student->esmt6->silat) : '-' }}</td>                       
                    </tr>
